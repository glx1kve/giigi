...
function Rload(currentLanguage) {
    ...
    if (currentLanguage === "ua") {
        ...
        lg_sign_in0_mobile.textContent = language.en.sign_in;
        lg_sign_up1_mobile.textContent = language.en.sign_up;
        lg_sign_in1_mobile.textContent = language.en.sign_in;
        lg_sign_up2_mobile.textContent = language.en.sign_up;
